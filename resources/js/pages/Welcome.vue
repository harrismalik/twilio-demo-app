    ...
    <div class="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
        <div class="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                ...
                >
                    <h1 class="mb-1 font-medium">Yo Telecom Twilio Agents Demo App</h1>
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        This is build upon laravel + vue. <br />We suggest starting with the following.
                    </p>
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        ...
                        >
                            ...
                            <span>
                                Github repo:
                                <a
                                    href="https://github.com/harrismalik/twilio-demo-app"
                                    target="_blank"
                        ...
                        >
                            ...
                            <span>
                                Docs:
                                <a
                                    href="https://github.com/harrismalik/twilio-demo-app/README"
                                    target="_blank"
                                    class="ml-1 inline-flex items-center space-x-1 font-medium text-[#f53003] underline underline-offset-4 dark:text-[#FF4433]"
                                >
                                    <span>README</span>
